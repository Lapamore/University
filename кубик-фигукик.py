...
num = "1" #Какой хотим файл, то значение и задаём
N, M = map(int, open("input_s1_"+num+".txt").readlines()[0].split())
X0, Y0, Z0 = map(int, open("input_s1_"+num+".txt").readlines()[1].split())
...
print(open("output_s1_"+num+".txt").readline()) #Для сравнения