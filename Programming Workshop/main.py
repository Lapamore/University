import telebot
bot = telebot.TeleBot("5789244493:AAGJff3_IXynNbUaDOKe5mNEjfjD7Hpgwn4")
...
def info(message):
    if message.text.lower() == "привет":
        bot.send_message(message.chat.id,
                         f"Привет, {message.from_user.first_name} {message.from_user.last_name}! Введи название своего персонажа")
        ...
        bot.send_photo(message.chat.id, photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//speed.jpg', 'rb'))

    elif message.text.lower() == "график брони":
        bot.send_message(message.chat.id,
                         '''График брони персонажей на первом уровне, от самого маленького до самого большего:''')
        bot.send_photo(message.chat.id, photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//armor.jpg', 'rb'))

    elif message.text.lower() == "тайминги":
        bot.send_message(message.chat.id, '''Тайминги патча 7.33c:''')
        bot.send_photo(message.chat.id, photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Timings.jpg', 'rb'))

    elif message.text.lower() in ("earthshaker ", "шейкер"):
        bot.send_message(message.chat.id, '''Вариант 1:''')
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Earthshaker//first_buy.png', 'rb'))
        bot.send_message(message.chat.id, '''Вариант 2:''')
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Earthshaker//second_buy.png', 'rb'))
        bot.send_message(message.chat.id, "Прокачивание скилов:")
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Earthshaker//skills.png', 'rb'))
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Enigma//first_buy.png', 'rb'))
        bot.send_message(message.chat.id,
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Enigma//second_buy.png', 'rb'))
        bot.send_message(message.chat.id, "Прокачивание скилов:")
        bot.send_photo(message.chat.id, photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Enigma//skills.png', 'rb'))
        bot.send_message(message.chat.id,
                         "Враги:\n1.Nature's Prophet\n2.Spectre\n3.Zeus\n4.Beastmaster\n5.Bounty Hunter\n6.Riki\n7.Nyx Assassin")
        bot.send_message(message.chat.id, "Cоюзники:\n1.Tidehunter\n2.Magnus\n3.Axe\n4.Slardar\n5.Axe\n6.Disruptor")
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Sniper//first_buy.png', 'rb'))
        bot.send_message(message.chat.id,
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Sniper//second_buy.png', 'rb'))
        bot.send_message(message.chat.id, "Прокачивание скилов:")
        bot.send_photo(message.chat.id, photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Sniper//skills.png', 'rb'))
        bot.send_message(message.chat.id,
                         "Враги:\n1.Leshrac\n2.Lina\n3.Puck\n4.Pugna\n5.Outworld Devourer\n6.Death Prophet\n7.Invoker\n8.Magnus\n9.Razor\n10.Templar Assassin")
        bot.send_message(message.chat.id,
                         "Cоюзники:\n1.Tidehunter\n2.Enigma\n3.Earthshaker\n4.Faceless Void\n5.Axe\n6.Clockwerk")
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Batrider//first_buy.png', 'rb'))
        bot.send_message(message.chat.id,
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Batrider//second_buy.png', 'rb'))
        bot.send_message(message.chat.id,
                         '''Вариант 3:\nТретий вариант можно использовать для средней линии, поэтому он предусматривает покупку бутылки.''')
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Batrider//third_buy.png', 'rb'))
        bot.send_message(message.chat.id, "Прокачивание скилов:")
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Batrider//skills.png', 'rb'))
        bot.send_message(message.chat.id,
                         "Враги:\n1.Meepo\n2.Broodmother\n3.Enchantress\n4.Visage\n5.Templar Assassin\n6.Tusk\n7.Treant Protector\n8.Terrorblade\n9.Earth Spirit\n10.Necrophos")
        bot.send_message(message.chat.id, "Cоюзники:\n1.Io\n2.Enigma\n3.Tinker\n4.Zeus\n5.Ursa\n6.Mirana")
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Windranger//first_buy.png', 'rb'))
        bot.send_message(message.chat.id,
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Windranger//second_buy.png', 'rb'))
        bot.send_message(message.chat.id, "Прокачивание скилов:")
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Windranger//skills.png', 'rb'))
        bot.send_message(message.chat.id,
                         "Враги:\n1.Dragon Knight\n2.Tiny\n3.Pudge\n4.Ember Spirit\n5.Magnus\n6.Ursa\n7.Lifestealer\n8.Lycan\n9.Sven\n10.Alchemist")
        bot.send_message(message.chat.id, "Cоюзники:\n1.Lion\n2.Shadow Shaman")
        ...
        bot.send_message(message.chat.id,
                         '''Данный вариант является своего рода классическим, если можно так выразиться. В конечном итоге мы получаем героя с очень хорошим уроном и отличной выживаемостью. Стоит понимать, что артефакты могут покупать в разном порядке. Самое главное следить за тем, что вам требуется именно в текущий момент.''')
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Huskar//first_buy.png', 'rb'))
        bot.send_message(message.chat.id, "Прокачивание скилов:")
        bot.send_photo(message.chat.id, photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Huskar//skills.png', 'rb'))
        bot.send_message(message.chat.id,
                         "Враги:\n1.Lina\n2.Omniknight\n3.Queen of Pain\n4.Tinker\n5.Enigma\n6.Bane\n7.Outworld Devourer")
        bot.send_message(message.chat.id,
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Magnus//first_buy.png', 'rb'))
        bot.send_message(message.chat.id,
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Magnus//second_buy.png', 'rb'))
        bot.send_message(message.chat.id,
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Magnus//third_buy.png', 'rb'))
        bot.send_message(message.chat.id,
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Magnus//fourth_buy.png', 'rb'))
        bot.send_message(message.chat.id, "Прокачивание скилов:")
        bot.send_photo(message.chat.id, photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Magnus//skills.png', 'rb'))
        bot.send_message(message.chat.id,
                         "Враги:\n1.Nature's Prophet\n2.Spectre\n3.Zeus\n4.Clockwerk\n5.Beastmaster\n6.Bounty Hunter\n7.Nyx Assassin")
        bot.send_message(message.chat.id,
                         "Cоюзники:\n1.Sand King\n2.Tidehunter\n3.Queen of Pain\n4.Shadow Fiend\n5.Kunkka")
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Tinker//first_buy.png', 'rb'))
        bot.send_message(message.chat.id,
                         '''Вариант 2:\nВо втором варианте используется Дагон, который значительно увеличит разовый урон Тинкера.''')
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Tinker//second_buy.png', 'rb'))
        bot.send_message(message.chat.id, "Прокачивание скилов:")
        bot.send_photo(message.chat.id, photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Tinker//skills.png', 'rb'))
        bot.send_message(message.chat.id,
                         "Враги:\n1.Viper\n2.Death Prophet\n3.Batrider\n4.Templar Assassin\n5.Storm Spirit\n6.Pugna\n7.Nyx Assassin\n8.Anti-Mage\n9.Spectre\n10.Ember Spirit")
        bot.send_message(message.chat.id,
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Arc_warden//first_buy.png', 'rb'))
        bot.send_message(message.chat.id,
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Arc_warden//second_buy.png', 'rb'))
        bot.send_message(message.chat.id,
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Arc_warden//third_buy.png', 'rb'))
        bot.send_message(message.chat.id, "Прокачивание скилов:")
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Arc_warden//skills.png', 'rb'))
        bot.send_message(message.chat.id,
                         "Враги:\n1.Lycan\n2.Chaos Knight\n3.Phantom Lancer\n4.Naga Siren\n5.Meepo\n6.Clinkz\n7.Riki\n8.Clinkz\n9.Bounty Hunter\n10.Slark")
        bot.send_message(message.chat.id, "Cоюзники:\n1.Oracle\n2.Witch Doctor\n3.Slardar\n4.Omniknight")
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Lion//third_buy.png', 'rb'))
        bot.send_message(message.chat.id, "Прокачивание скилов:")
        bot.send_photo(message.chat.id, photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Lion//skills.png', 'rb'))
        bot.send_message(message.chat.id,
                         "Враги:\n1.Visage\n2.Pugna\n3.Bane\n4.Chen\n5.Enchantress\n6.Nature's Prophet\n7.Oracle\n8.Clinkz\n9.Nyx Assassin\n10.Clockwerk")
        bot.send_message(message.chat.id,
                         "Cоюзники:\n1.Chen\n2.Enchantress\n3.Lina\n4.Slardar\n5.Enchantress\n6.Centaur Warrunner\n7.Phantom Assassin\n8.Ursa")
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Slark//first_buy.png', 'rb'))
        bot.send_message(message.chat.id,
                         '''Вариант 2:\nВторой вариант это своего рода универсальная сборка, которую можно использовать для большинства ситуаций.''')
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Slark//second_buy.png', 'rb'))
        bot.send_message(message.chat.id, '''Вариант 3:\nПоследний вариант подойдет для очень агрессивной игры.''')
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Slark//third_buy.png', 'rb'))
        bot.send_message(message.chat.id, "Прокачивание скилов:")
        bot.send_photo(message.chat.id, photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Slark//skills.png', 'rb'))
        bot.send_message(message.chat.id,
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Juggernaut//first_buy.png', 'rb'))
        bot.send_message(message.chat.id,
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Juggernaut//second_buy.png', 'rb'))
        bot.send_message(message.chat.id,
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Juggernaut//third_buy.png', 'rb'))
        bot.send_message(message.chat.id, "Прокачивание скилов:")
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Juggernaut//skills.png', 'rb'))
        bot.send_message(message.chat.id,
                         "Враги:\n1.Wraith King\n2.Ursa\n3.Sven\n4.Lifestealer\n5.Slark\n6.Chaos Knight\n7.Night Stalker\n8.Omniknight\n9.Abaddon\n10.Necrophos")
        bot.send_message(message.chat.id,
                         "Cоюзники:\n1.Crystal Maiden\n2.Lion\n3.Rubick\n4.Shadow Shaman\n5.Witch Doctor\n6.Vengeful Spirit\n7.Venomancer")
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Zeus//first_buy.png', 'rb'))
        bot.send_message(message.chat.id,
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Zeus//second_buy.png', 'rb'))
        bot.send_message(message.chat.id,
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Zeus//third_buy.png', 'rb'))
        bot.send_message(message.chat.id, "Прокачивание скилов:")
        bot.send_photo(message.chat.id, photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Zeus//skills.png', 'rb'))
        bot.send_message(message.chat.id,
                         "Враги:\n1.Axe\n2.Enigma\n3.Earthshaker\n4.Slardar\n5.Sand King\n6.Enchantress\n7.Crystal Maiden\n8.Luna\n9.Venomancer\n10.Windranger")
        bot.send_message(message.chat.id, "Cоюзники:\n1.Crystal Maiden\n2.Bloodseeker\n3.Enigma")
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Pudge//first_buy.png', 'rb'))
        bot.send_message(message.chat.id,
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Pudge//second_buy.png', 'rb'))
        bot.send_message(message.chat.id,
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Pudge//third_buy.png', 'rb'))
        bot.send_message(message.chat.id,
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Pudge//fourth_buy.png', 'rb'))
        bot.send_message(message.chat.id, "Прокачивание скилов:")
        bot.send_photo(message.chat.id, photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Pudge//skills.png', 'rb'))
        bot.send_message(message.chat.id,
                         "Враги:\n1.Centaur Warrunner\n2.Clockwerk\n3.Slardar\n4.Doom\n5.Wraith King\n6.Dragon Knight\n7.Puck\n8.Storm Spirit\n9.Queen of Pain\n10.Weaver")
        bot.send_message(message.chat.id, "Cоюзники:\n1.Omniknight\n2.Dark Seer\n3.Io\n4.Oracle\n5.EarthShaker")
        ...
        bot.send_photo(message.chat.id, photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Io//first_buy.png', 'rb'))
        bot.send_message(message.chat.id,
        ...
        bot.send_photo(message.chat.id, photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Io//second_buy.png', 'rb'))
        bot.send_message(message.chat.id, "Прокачивание скилов:")
        bot.send_photo(message.chat.id, photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Io//skills.png', 'rb'))
        bot.send_message(message.chat.id,
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Crystal_maiden//first_buy.png', 'rb'))
        bot.send_message(message.chat.id,
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Crystal_maiden//second_buy.png', 'rb'))
        bot.send_message(message.chat.id,
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Crystal_maiden//third_buy.png', 'rb'))
        bot.send_message(message.chat.id, "Прокачивание скилов:")
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Crystal_maiden//skills.png', 'rb'))
        bot.send_message(message.chat.id,
                         "Враги:\n1.Troll Warlord\n2.Phantom Assassin\n3.Bounty Hunter\n4.Dragon Knight\n5.Lycan\n6.Alchemist\n7.Templar Assassin\n8.Night Stalker\n9.Ursa\n10.Viper")
        bot.send_message(message.chat.id,
                         "Cоюзники:\n1.Juggernaut\n2.Phantom Assassin\n3.Sven\n4.Spectre\n5.Anti-Mage\n6.Slark\n7.Lifestealer\n8.Chaos Knight")
        ...
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Tiny//first_buy.png', 'rb'))
        bot.send_message(message.chat.id,
                         '''Вариант 2\nВторой вариант больше подойдет для тех ситуаций, когда необходимо большое количество здоровья и защита.''')
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Tiny//second_buy.png', 'rb'))
        bot.send_message(message.chat.id,
                         '''Вариант 3:\nПоследний вариант позволяет получить Тини с очень мощной разовой автоатакой.''')
        bot.send_photo(message.chat.id,
                       photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Tiny//third_buy.png', 'rb'))
        bot.send_message(message.chat.id, "Прокачивание скилов:")
        bot.send_photo(message.chat.id, photo=open('C://Users//Дмитрий//Documents//FAQ_DOTA//Tiny//skills.png', 'rb'))
        bot.send_message(message.chat.id,
                         "Враги:\n1.Necrophos\n2.Omniknight\n3.Lifestealer\n4.Zeus\n5.Doom\n6.Bristleback")
        bot.send_message(message.chat.id,
